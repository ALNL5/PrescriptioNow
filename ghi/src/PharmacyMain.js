    ...
    return (
      <div className="container">
        <div className="row gx-4 p-8 mb-5 pharmacist">
            ...
            <p><a className="btn btn-lg" href="/pharmacy/prescriptions/orders/" role="button">View refill orders</a></p>
            <p><a className="btn btn-lg" href="/pharmacy/order-history/" role="button">View refill order history</a></p>
            </div>
            </div>
        </div>
      </div>
